...
int Entity::GetWeaponId(void* weapon)
{
	short id = mem->Read<short>(GetActiveWeaponBase() + ofs->m_iItemDefinitionIndex);
	...
	int ClassID = mem->Read<int>(mem->Read<int>(mem->Read<int>(mem->Read<int>(GetActiveWeaponBase() + 0x8) + 2 * 0x4) + 0x1) + 0x14);

	switch (ClassID)
	{
	case (int)CSGOClassID::CWeaponMAC10:
		return 18;
	case (int)CSGOClassID::CWeaponMP5Navy:
		return 19;
	case (int)CSGOClassID::CWeaponMP7:
		return 20;
	case (int)CSGOClassID::CWeaponMP9:
		return 21;
	case (int)CSGOClassID::CWeaponP90:
		return 22;
	case (int)CSGOClassID::CWeaponUMP45:
		return 23;
	case (int)CSGOClassID::CWeaponBizon:
		return 24;
	case (int)CSGOClassID::CWeaponMag7:
		return 25;
	case (int)CSGOClassID::CWeaponXM1014:
		return 26;
	case (int)CSGOClassID::CWeaponNegev:
		return 27;
	case (int)CSGOClassID::CWeaponSawedoff:
		return 28;
	case (int)CSGOClassID::CWeaponNOVA:
		return 29;
	case (int)CSGOClassID::CWeaponM249:
		return 30;
